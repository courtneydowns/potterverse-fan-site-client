...
import APIRUL from "../../helper/environment";

class PotionIngredientCommentUpdate extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  commentUpdate = () => {
    fetch(`${APIRUL}/comment/edit/magical-objects/${this.state.commentId}`, {
      method: "PUT",
      body: JSON.stringify({
        comment: {
...
export default PotionIngredientCommentUpdate;
